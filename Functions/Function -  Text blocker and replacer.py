...
def textBlock(textIN): #Takes a plaintext string input and returns a list with strings of blocked characters
    n = 2 #The size of the text blocks
    text = list(textIN)
    length = len(text)
    blockedText = []
    remainder = length % n
...
x = ""
y = textBlock(x)
print(y)
z = textReplace(y,"fb","e")
print(z)